...
def print_board(board):
    ...
    horizontal_border = "+" + ("-" * (2 * subgrid_size + subgrid_size - 1) + "+") * subgrid_size
...
# Example 9x9 puzzle
SPG = SudokuPuzzleGenerator(size=9)
solution = SPG.generate_full_solution()
puzzle = SPG.remove_values_to_create_puzzle(solution, clues=30)
