...
if __name__ == "__main__":
    size = 4 
    clues = 5
    generator = SudokuPuzzleGenerator(size)
    full_solution = generator.generate_full_solution()
    puzzle = generator.remove_values_to_create_puzzle(full_solution, clues=clues)

    print("Full Solution:")
    generator.print_board(full_solution)
